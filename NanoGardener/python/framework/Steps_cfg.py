...
### OLD stuff End
  ...
  'MCCorr2018SusyFSv6' : {
                     ...
                     'do4MC'      : True  ,
                     'do4Data'    : False ,
                     'subTargets' : ['susyW','btagPerJet2018FS','btagPerEvent2018FS','btagPerEvent2018FSPt25','btagPerEvent2018FSPt30',
                                     'rochesterMC','trigFS','trigFS_Cut','LeptonSFSusyFS','puW','EmbeddingVeto',
                                     'wwNLOEWK','wzNLOEWK','zzNLOEWK','zNLOEWK', 'wNLOEWK' ],
                },
